...
def find_biggest_contour(image):
    ...
    image,coutours,hierachy=cv2.findContours(image,cv2.RETR_LIST,cv2.CHAIN_APPROX_SIMPLE)
    #isolating the largest contour
    contour_sizes=[(cv2.contourArea(contour),contour) for contour in coutours]
